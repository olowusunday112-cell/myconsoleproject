...
SecurityCheck:
        ...
        '           USER DETAILS INPUT
        '-------------------------------------------
        Dim bvn, nin, accountNumber As String

        ' Get BVN
        Do
            Console.WriteLine("ENTER YOUR BVN (11 digits): ")
            bvn = Console.ReadLine()
            If bvn.Length <> 11 Or Not IsNumeric(bvn) Then
                Console.ForegroundColor = ConsoleColor.Red
                Console.WriteLine("ERROR! BVN must be 11 digits and in numeric form")
                Console.ResetColor()
            Else
                Exit Do
            End If
        ...
        ' Get NIN
        Do
            Console.Writeline("ENTER YOUR NIN (11 digits): ")
            nin = Console.ReadLine()
            If nin.Length <> 11 Or Not IsNumeric(nin) Then
                Console.ForegroundColor = ConsoleColor.Red
                Console.WriteLine("ERROR! NIN must be 11 digits.")
                Console.ResetColor()
            Else
                Exit Do
            End If
        ...
        ' Get Account Number
        Do
            Console.WriteLine("ENTER YOUR BANK ACCOUNT NUMBER (10 digits): ")
            accountNumber = Console.ReadLine()
            If accountNumber.Length <> 10 Or Not IsNumeric(accountNumber) Then
                Console.ForegroundColor = ConsoleColor.Red
                Console.WriteLine("ERROR! Account number must be 10 digits.")
                Console.ResetColor()
            Else
                Exit Do
            End If
        ...
        Console.ForegroundColor = ConsoleColor.Green
        Console.WriteLine("USER DETAILS SUCCESSFULLY RECORDED!")
        Console.ResetColor()
        Console.WriteLine()
